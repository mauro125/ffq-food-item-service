...
public class FFQCalculator {
	...
	public static Result calculateTotals(String questionnaireId, String userId, String userType, String date, int ageInMonths, ArrayList<FoodItemInput> userChoices,
		...
		if (userChoices.size() == 0) {
			...
			return new Result(questionnaireId, userId, userType, date, ageInMonths, userChoices, weeklyTotals, dailyAverages, null, gender);
		}
		...
		Result results = new Result(questionnaireId, userId, userType, date, ageInMonths, userChoices, weeklyTotals, dailyAverages, null, gender);
		//End of added code
		//===============================================================
		return results;
	}
